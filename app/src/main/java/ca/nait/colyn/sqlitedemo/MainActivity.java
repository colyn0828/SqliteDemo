...
import ca.nait.colyn.sqlitedemo.databinding.ActivityMainBinding;
...
//        setContentView(R.layout.activity_main);
    ...
    private void rebindRecyclerView() {
        ...
        binding.activityMainCategoriesRecycleview.setAdapter(recyclerViewAdapter);
        binding.activityMainCategoriesRecycleview.setLayoutManager(new LinearLayoutManager(this));
    }
...
//            String message = String.format("Save successfully with id %s", categoryId);
...
//                    Toast.makeText(context, "Edit category received", Toast.LENGTH_SHORT).show();
    ...
    // Broadcast Receiver Step 1: Create an instance of the custom BroadcastReceiver class
    ...
    public void addCategory(Category newCategory) {
        ...
        if (dbHelper.addCategory(newCategory) > 0) {
            ...
            Toast.makeText(this, "Add category unsuccessfully", Toast.LENGTH_SHORT).show();
        }
    }
}