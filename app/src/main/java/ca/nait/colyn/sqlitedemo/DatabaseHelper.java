...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String cat3Prod1 = "INSERT INTO product_table(product_name, unit_price, category_id) VALUES ('Cat 3 Product 1', 9.87, 1)";
        final String cat3Prod2 = "INSERT INTO product_table(product_name, unit_price, category_id) VALUES ('Cat 3 Product 2', 6.54, 1)";
        final String cat3Prod3 = "INSERT INTO product_table(product_name, unit_price, category_id) VALUES ('Cat 3 Product 3', 3.21, 1)";
    ...
    public Cursor getProductByCategoryId(int categoryId) {
        SQLiteDatabase db = getReadableDatabase();
        String[] columns = {
    ...
    private Category mapCursorToCateogory(Cursor queryResultCursor) {
...
//            currentCategory.setCategoryId(queryResultCursor.getInt(0));
//            currentCategory.setCategoryName(queryResultCursor.getString(1));
            Category currentCategory = mapCursorToCateogory(queryResultCursor);
    ...
    public Category findOneCategoryById(int categoryId) {
        ...
        if (queryResultCursor.moveToNext()) {
            existingCategory = mapCursorToCateogory(queryResultCursor);
        }
